package com.hiynn.file.upload.untils;
...
public class FTPUtil {
     ...
     * FTP地址
     **/
    private static final String FTP_ADDRESS = "192.168.238.106";

    /**
     * FTP端口
     **/
    private static final int FTP_PORT = 2341;
     ...
     * @param multipartFile MultipartFile multipartFile
     * @param fileName 上传到FTP服务的文件名，例如：666.txt
     * @return boolean 成功返回true，否则返回false
     */
    public boolean uploadLocalStream(String ftpPath, MultipartFile multipartFile, String fileName) {
        // 登录
        ...
        if (ftpClient != null) {
            try {
                ...
                // 上传文件
                flag = ftpClient.storeFile(new String(fileName.getBytes(localCharset), serverCharset), multipartFile.getInputStream());
            } catch (Exception e) {
