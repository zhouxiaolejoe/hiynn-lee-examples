...
public class ZipUtil {
	...
	public static void toZip(String srcDir, String outPathFile,boolean isDelSrcFile) throws Exception {
		...
		try {
			...
			if(isDelSrcFile){
				boolean srcDir1 = FileUtils.deleteQuietly(new File(srcDir));
				System.err.println(srcDir1);
			}
	...
	public static void unZipFiles(String zipPath, String descDir,boolean isDelSrcFile) throws IOException {
